...
def pandas_descriptive_stat_mean(df: pl.DataFrame, col: str) -> float:
    return df[col].mean()

def pandas_descriptive_stat_median(df: pl.DataFrame, col: str) -> float:
    return df[col].median()

def pandas_descriptive_stat_std(df: pl.DataFrame, col: str) -> float:
    return df[col].std()
